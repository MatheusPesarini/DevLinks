				...
				<div className="bg-card p-8 rounded-xl shadow-xl w-full max-w-md">
					<Form action={formAction}>
						<Stack className="gap-6">
							...
							<Input id="username" name='username' label="Nome de usuário" type="text" required />
							...
							<Input id="confirmPassword" name='confirmPassword' label="Confirmar Senha" type="password" required />
